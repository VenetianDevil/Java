...
public class PMO_Test {
    ...
    private static final String PASSWORD_03 = "AlaMiaĹaKota";
    private static final String PASSWORD_04 = "AlaKupiĹaKota";
    ...
    private void testSetGet( double[] values2set, double[] expectedGet, boolean modificationExpected,
        ...
        for ( int i = 0; i < values2set.length; i++ ) {
            ...
            if ( setResultTestOn )
                assertEquals( modificationExpected, setResult, "BĹÄdny wynik metody set dla set(" + i + ", " + values2set[i] + ")" ) ;
            valueGet = executeGet( i );
            if ( expectedGet != null )
                assertEquals( expectedGet[ i ], valueGet, 0.001, "Metoda get(" + i +
                        ") zwrĂłciĹa innÄ wartoĹÄ niĹź uczekiwano");
        }
    }
    ...
    private void testMoveGet( double[] values2set, double[] expectedGet, boolean modificationExpected,
        ...
        for ( int i = 0; i < values2set.length; i++ ) {
            ...
            if ( setResultTestOn )
                assertEquals( modificationExpected, setResult, "BĹÄdny wynik metody move dla set(" + i + ", " + values2set[i] + ")" ) ;
            valueGet = executeGet( i );
            if ( expectedGet != null )
                assertEquals( expectedGet[ i ], valueGet, 0.001, "Metoda get(" + i +
                        ") zwrĂłciĹa innÄ wartoĹÄ niĹź uczekiwano");
    ...
    @Test
    @DisplayName( "Test stanu poczÄtkowego")
    public void initialStateTest() {
        setDimensions( 123 );
        assertEquals(0, executeLockLevel(), "Oczekiwano, Ĺźe nowy obiekt nie ma ochrony. lockLevel powinien wynosiÄ 0" );
    }
    ...
    @Test
    @DisplayName( "Test wyniku zwracanego przez unlock przy bĹÄdnym haĹle")
    ...
    @ParameterizedTest
    @MethodSource( "simpleSetGetTestDataProvider" )
    @DisplayName( "Test poprawnoĹci dziaĹania set/get")
    ...
    @ParameterizedTest
    @MethodSource( "simpleSetGetTestDataProvider" )
    @DisplayName( "Test wyniku zwracanego przez zablokowanÄ/odblokowanÄ metodÄ set")
    ...
    @ParameterizedTest
    @MethodSource( "simpleSetGetTestDataProvider" )
    @DisplayName( "Test poprawnoĹci dziaĹania zablokowanego/odblokowanego set/get")
    ...
    @ParameterizedTest
    @MethodSource( "simpleSetGetTestDataProvider" )
    @DisplayName( "Test wyniku zwracanego niepopranie odblokowanÄ metodÄ set")
    ...
    @ParameterizedTest
    @MethodSource( "simpleSetGetTestDataProvider" )
    @DisplayName( "Test poprawnoĹci dziaĹania niepoprawnie odblokowanego set")
    ...
    @ParameterizedTest
    @MethodSource( "simpleSetMoveGetTestDataProvider" )
    @DisplayName( "Test poprawnoĹci dziaĹania niezablokowanego set/move/get")
    public void simpleSetMoveGetTest( double[] values2set, double[] values2move, double[] expectedGet ) {
        ...
        // jeĹli set nie zadziaĹa, to sprawdzanie move nie ma sensu
        testMoveGet( values2move, expectedGet, true, false );
    }

    @ParameterizedTest
    @MethodSource( "simpleSetMoveGetTestDataProvider" )
    @DisplayName( "Test poprawnoĹci dziaĹania zablokowanego move")
